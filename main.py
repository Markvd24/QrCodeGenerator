...
CHARACTER_COUNT_INDICATOR_LENGTH = [[10, 9, 8], [12, 11, 16], [14, 13, 16]][floor((QR_CODE_VERSION + 7) / 17)][MODE_INDICATOR]
...
error_correction_information = error_correction_information_per_version_mode[QR_CODE_VERSION - 1][MODE_INDICATOR]
